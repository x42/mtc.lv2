...
extern const TimecodeRate* TCFPS23976;  ///< { 24000, 1001, 0, 80};
extern const TimecodeRate* TCFPS24;     ///< {    24,    1, 0, 80};
extern const TimecodeRate* TCFPS24976;  ///< { 25000, 1001, 0, 80};
extern const TimecodeRate* TCFPS25;     ///< {    25,    1, 0, 80};
extern const TimecodeRate* TCFPS2997DF; ///< { 30000, 1001, 1, 80};
extern const TimecodeRate* TCFPS30;     ///< {    30,    1, 0, 80};
extern const TimecodeRate* TCFPSMS;     ///< {  1000,    1, 0, 1000};
